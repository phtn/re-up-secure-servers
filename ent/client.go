...
func (c *AccountClient) QueryGroups(a *Account) *GroupQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, account.GroupsTable, account.GroupsColumn),
		)
...
// QueryAccount queries the account edge of a Group.
func (c *GroupClient) QueryAccount(gr *Group) *AccountQuery {
...
type (
	hooks struct {
		Account, Group, User []ent.Hook
	}
	inters struct {
		Account, Group, User []ent.Interceptor
	}
)
